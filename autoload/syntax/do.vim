...
"Quang added
syn keyword tclStatement analyze report uniquify elaborate dofile setenv version reset add 
syn keyword tclStatement date vpx vpxmode tclmode write
...
"Quang:syn keyword tcltkStringSwitch	contained	compare first index last length match range tolower toupper trim trimleft trimright wordstart wordend
syn keyword tcltkStringSwitch	contained	first index last length match range tolower toupper trim trimleft trimright wordstart wordend
