...
"autocmd BufRead * if getfsize(expand("%")) > g:LargeFile*1024*1024 | NeoComplCacheLock | endif
call LargeFileCmd('NeoComplCacheLock')
...
if $MYGROUP==""
  ...
  let g:neocomplcache_temporary_dir = "/proj/$MYGROUP/wa/$USER/.neocomplcache"
endif
